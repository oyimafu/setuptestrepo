Session 01 — Secure Access to Resources Using Microsoft Entra
SC-500 — Microsoft Entra identity and access management
...
Fork the repository from Microsoft-Naija-Security-Usergroup/github-onboarding-workshop
Navigate to classes/ and open this file
Fill in your GitHub username and complete all sections below
Commit with a message like: docs: add [Your Name] notes for Session 01
Open a Pull Request back to this repo
My Details
Name:
GitHub Username:
Session Attended: Session 01 — Saturday, 4 July 2026
...
Resource	Link
Microsoft Learn Module	https://learn.microsoft.com/en-us/training/paths/secure-access-resources-entra/
Self-Assessment
How confident do you feel about this topic after today? (1 = not confident, 5 = very confident)

What would you like to explore further?

MNSUG SC-500 Mentorship Program · Saturday, 4 July 2026 · Learn. Secure. Innovate.
